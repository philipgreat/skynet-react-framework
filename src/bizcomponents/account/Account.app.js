...
class AccountBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/account/${this.props.account.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {AccountPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/account/:id/dashboard", component: AccountDashboard},
  	{path:"/account/:id/preference", component: AccountPreference},
