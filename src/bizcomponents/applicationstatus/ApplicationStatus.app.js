...
import styles from './ApplicationStatus.app.less'
...
class ApplicationStatusBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/applicationStatus/${this.props.applicationStatus.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/applicationStatus/${this.props.applicationStatus.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	const {ApplicationStatusDashboard} = GlobalComponents
  	const {ApplicationStatusPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/applicationStatus/:id/dashboard", component: ApplicationStatusDashboard},
  	{path:"/applicationStatus/:id/preference", component: ApplicationStatusPreference},
  	
  	
  	
  	{path:"/applicationStatus/:id/list/bookCopySharingApplicationList", component: this.getBookCopySharingApplicationSearch()},
  	{path:"/applicationStatus/:id/list/bookCopySharingApplicationCreateForm", component: this.getBookCopySharingApplicationCreateForm()},
  	{path:"/applicationStatus/:id/list/bookCopySharingApplicationUpdateForm", component: this.getBookCopySharingApplicationUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {ApplicationStatusEditDetail} = GlobalComponents
     //const {ApplicationStatusViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.applicationStatus.id)}
