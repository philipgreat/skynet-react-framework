...
const menuData = {menuName:"申请状态", menuFor: "applicationStatus",
  		subItems: [
...
const displayColumns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderIdentifier(text,record,'applicationStatus') },
