...
import styles from './ApplicationStatus.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import ApplicationStatusBase from './ApplicationStatus.base'
...
class ApplicationStatusCreateForm extends Component {
  state = {
  ...
  executeCandidateBookSharingPlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = ApplicationStatusService.requestCandidateBookSharingPlatform("bookSharingPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addApplicationStatus`,
          payload: { id: owner.id, type: 'applicationStatus', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(ApplicationStatusCreateForm))
