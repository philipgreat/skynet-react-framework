...
import styles from './ApplicationStatus.updateform.less'
...
class ApplicationStatusUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextApplicationStatusUpdateRow`,
        payload: {
          id: owner.id,
          type: 'applicationStatus',
          selectedRows,
...
}))(Form.create()(ApplicationStatusUpdateForm))
