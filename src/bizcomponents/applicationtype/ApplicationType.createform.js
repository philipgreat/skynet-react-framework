...
import styles from './ApplicationType.createform.less'
...
class ApplicationTypeCreateForm extends Component {
  state = {
  ...
  executeCandidatePlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = ApplicationTypeService.requestCandidatePlatform("dataPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addApplicationType`,
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addApplicationType`,
          payload: { id: owner.id, type: 'applicationType', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'applicationType',listName:'申请类型列表' },
      })
    }
...
}))(Form.create()(ApplicationTypeCreateForm))
