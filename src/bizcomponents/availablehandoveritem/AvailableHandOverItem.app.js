...
class AvailableHandOverItemBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/availableHandOverItem/${this.props.availableHandOverItem.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {AvailableHandOverItemPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/availableHandOverItem/:id/dashboard", component: AvailableHandOverItemDashboard},
  	{path:"/availableHandOverItem/:id/preference", component: AvailableHandOverItemPreference},
  	
  	
  	
  	{path:"/availableHandOverItem/:id/list/handOverChecklistItemList", component: this.getHandOverChecklistItemSearch()},
  	{path:"/availableHandOverItem/:id/list/handOverChecklistItemCreateForm", component: this.getHandOverChecklistItemCreateForm()},
  	{path:"/availableHandOverItem/:id/list/handOverChecklistItemUpdateForm", component: this.getHandOverChecklistItemUpdateForm()},
   	
  	{path:"/availableHandOverItem/:id/list/handOverChecklistResultList", component: this.getHandOverChecklistResultSearch()},
  	{path:"/availableHandOverItem/:id/list/handOverChecklistResultCreateForm", component: this.getHandOverChecklistResultCreateForm()},
  	{path:"/availableHandOverItem/:id/list/handOverChecklistResultUpdateForm", component: this.getHandOverChecklistResultUpdateForm()},
