...
class AvailableProductBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/availableProduct/${this.props.availableProduct.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {AvailableProductPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/availableProduct/:id/dashboard", component: AvailableProductDashboard},
  	{path:"/availableProduct/:id/preference", component: AvailableProductPreference},
