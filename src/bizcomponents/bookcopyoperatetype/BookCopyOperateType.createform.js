...
import styles from './BookCopyOperateType.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import BookCopyOperateTypeBase from './BookCopyOperateType.base'
...
class BookCopyOperateTypeCreateForm extends Component {
  state = {
  ...
  executeCandidateBookSharingPlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = BookCopyOperateTypeService.requestCandidateBookSharingPlatform("bookSharingPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const {fieldLabels} = BookCopyOperateTypeBase
    const submitCreateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addBookCopyOperateType`,
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addBookCopyOperateType`,
          payload: { id: owner.id, type: 'bookCopyOperateType', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'bookCopyOperateType',listName:'书籍副本操作类型列表' },
      })
    }
...
}))(Form.create()(BookCopyOperateTypeCreateForm))
