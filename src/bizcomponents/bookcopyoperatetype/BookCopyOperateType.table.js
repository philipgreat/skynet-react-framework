...
import styles from './BookCopyOperateType.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import BookCopyOperateTypeBase from './BookCopyOperateType.base'


class BookCopyOperateTypeTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = BookCopyOperateTypeBase
    if(!referenceName){
...
export default BookCopyOperateTypeTable
