...
const displayColumns = [
  ...
  { title: '共享数量', debugtype: 'string', dataIndex: 'bookCopyQuantity', width: '6' },
  { title: '共享方式', dataIndex: 'deliverMethod', render: (text, record) => (record.deliverMethod ? record.deliverMethod.displayName : '暂无') },
  ...
  { title: '应用程序状态', dataIndex: 'applicationStatus', render: (text, record) => (record.applicationStatus ? record.applicationStatus.displayName : '暂无') },
