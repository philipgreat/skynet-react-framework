...
import styles from './BookCopySharingApplication.preference.less'
...
class BookCopySharingApplicationPreference extends Component {
...
}))(Form.create()(BookCopySharingApplicationPreference))
