...
class BookCopyStatusBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/insuranceServiceAccount/${this.props.insuranceServiceAccount.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
<<<<<<< HEAD:src/bizcomponents/insuranceserviceaccount/InsuranceServiceAccount.app.js
  	const {InsuranceServiceAccountDashboard} = GlobalComponents
  	const {InsuranceServiceAccountPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/insuranceServiceAccount/:id/dashboard", component: InsuranceServiceAccountDashboard},
  	{path:"/insuranceServiceAccount/:id/preference", component: InsuranceServiceAccountPreference},
...
>>>>>>> 69fce8703114b35fde9082e9f806d4b3dd160efb:src/bizcomponents/bookcopystatus/BookCopyStatus.app.js
