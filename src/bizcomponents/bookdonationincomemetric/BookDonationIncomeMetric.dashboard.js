...
import styles from './BookDonationIncomeMetric.dashboard.less'
...
class BookDonationIncomeMetricDashboard extends Component {
...
}))(Form.create()(BookDonationIncomeMetricDashboard))
