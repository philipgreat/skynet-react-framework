...
import styles from './BookDonationIncomeMetric.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import BookDonationIncomeMetricBase from './BookDonationIncomeMetric.base'


class BookDonationIncomeMetricTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = BookDonationIncomeMetricBase
    if(!referenceName){
...
export default BookDonationIncomeMetricTable
