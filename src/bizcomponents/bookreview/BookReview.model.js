...
<<<<<<< HEAD:src/bizcomponents/availablehandoveritem/AvailableHandOverItem.model.js
      const cachedData = yield select(state => state._availableHandOverItem)
=======
      const cachedData = yield select(state => state._bookReview)
>>>>>>> 69fce8703114b35fde9082e9f806d4b3dd160efb:src/bizcomponents/bookreview/BookReview.model.js
...
>>>>>>> 69fce8703114b35fde9082e9f806d4b3dd160efb:src/bizcomponents/bookreview/BookReview.model.js
    ...
    *doJob({ payload }, { call, put }) { 
      ...
      if(!BookReviewService[serviceNameToCall]){
      	handleClientError("找不到后台服务: "+serviceNameToCall)
      	return;
      }
      
      const data = yield call(BookReviewService[serviceNameToCall], id, parameters)
    ...
    *updateInform({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext, selectedRows, currentUpdateIndex } = payload
      console.log('get form parameters', parameters)
      const data = yield call(BookReviewService.updateInform, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
