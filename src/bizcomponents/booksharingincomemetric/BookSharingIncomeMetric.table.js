...
import styles from './BookSharingIncomeMetric.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import BookSharingIncomeMetricBase from './BookSharingIncomeMetric.base'


class BookSharingIncomeMetricTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = BookSharingIncomeMetricBase
    if(!referenceName){
...
export default BookSharingIncomeMetricTable
