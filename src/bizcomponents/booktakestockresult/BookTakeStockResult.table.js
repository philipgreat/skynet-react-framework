...
import styles from './BookTakeStockResult.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import BookTakeStockResultBase from './BookTakeStockResult.base'


class BookTakeStockResultTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = BookTakeStockResultBase
    if(!referenceName){
...
export default BookTakeStockResultTable
