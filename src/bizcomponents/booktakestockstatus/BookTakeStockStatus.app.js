...
import styles from './BookTakeStockStatus.app.less'
...
class BookTakeStockStatusBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/bookTakeStockStatus/${this.props.bookTakeStockStatus.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/bookTakeStockStatus/${this.props.bookTakeStockStatus.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	const {BookTakeStockStatusDashboard} = GlobalComponents
  	const {BookTakeStockStatusPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/bookTakeStockStatus/:id/dashboard", component: BookTakeStockStatusDashboard},
  	{path:"/bookTakeStockStatus/:id/preference", component: BookTakeStockStatusPreference},
  	
  	
  	
  	{path:"/bookTakeStockStatus/:id/list/bookTakeStockResultList", component: this.getBookTakeStockResultSearch()},
  	{path:"/bookTakeStockStatus/:id/list/bookTakeStockResultCreateForm", component: this.getBookTakeStockResultCreateForm()},
  	{path:"/bookTakeStockStatus/:id/list/bookTakeStockResultUpdateForm", component: this.getBookTakeStockResultUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {BookTakeStockStatusEditDetail} = GlobalComponents
     //const {BookTakeStockStatusViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.bookTakeStockStatus.id)}
