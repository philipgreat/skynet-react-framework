...
import styles from './BookTakeStockStatus.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import BookTakeStockStatusBase from './BookTakeStockStatus.base'
...
class BookTakeStockStatusCreateForm extends Component {
  state = {
  ...
  executeCandidateBookSharingPlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = BookTakeStockStatusService.requestCandidateBookSharingPlatform("bookSharingPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const {fieldLabels} = BookTakeStockStatusBase
    const submitCreateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addBookTakeStockStatus`,
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addBookTakeStockStatus`,
          payload: { id: owner.id, type: 'bookTakeStockStatus', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'bookTakeStockStatus',listName:'图书盘点状态列表' },
      })
    }
...
}))(Form.create()(BookTakeStockStatusCreateForm))
