...
class BorrowingHistoryBizApp extends React.PureComponent {
  ...
  getBorrowingExpiredSkuUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_borrowingHistory', id: state._borrowingHistory.id, listName: 'borrowingExpiredSkuList', ref:state._borrowingHistory, listDisplayName: '借书超期费列表' }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	{path:"/borrowingHistory/:id/list/borrowingExpiredSkuCreateForm", component: this.getBorrowingExpiredSkuCreateForm()},
  	{path:"/borrowingHistory/:id/list/borrowingExpiredSkuUpdateForm", component: this.getBorrowingExpiredSkuUpdateForm()},
