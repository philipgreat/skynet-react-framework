...
import styles from './BorrowingStatus.app.less'
...
class BorrowingStatusBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/borrowingStatus/${this.props.borrowingStatus.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/borrowingStatus/${this.props.borrowingStatus.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	const {BorrowingStatusDashboard} = GlobalComponents
  	const {BorrowingStatusPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/borrowingStatus/:id/dashboard", component: BorrowingStatusDashboard},
  	{path:"/borrowingStatus/:id/preference", component: BorrowingStatusPreference},
  	
  	
  	
  	{path:"/borrowingStatus/:id/list/borrowingHistoryList", component: this.getBorrowingHistorySearch()},
  	{path:"/borrowingStatus/:id/list/borrowingHistoryCreateForm", component: this.getBorrowingHistoryCreateForm()},
  	{path:"/borrowingStatus/:id/list/borrowingHistoryUpdateForm", component: this.getBorrowingHistoryUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {BorrowingStatusEditDetail} = GlobalComponents
     //const {BorrowingStatusViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.borrowingStatus.id)}
