...
import styles from './BorrowingStatus.preference.less'
...
class BorrowingStatusPreference extends Component {
  ...
  render() {
    ...
    const { id,displayName, borrowingHistoryCount } = this.props.borrowingStatus
...
}))(Form.create()(BorrowingStatusPreference))
