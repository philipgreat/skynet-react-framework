...
const displayColumns = [
  ...
  { title: '活动状态', dataIndex: 'campaignStatus', render: (text, record) => (record.campaignStatus ? record.campaignStatus.displayName : '暂无') },
  ...
  { title: '开始前几小时停止注册', debugtype: 'int', dataIndex: 'registerDeadlineLeadHours', width: '6' },
  { title: '最低注册数量', debugtype: 'int', dataIndex: 'minimumRegisterQuantity', width: '7' },
  { title: '报名人数限制', debugtype: 'int', dataIndex: 'availableRegisterQuantity', width: '7' },
