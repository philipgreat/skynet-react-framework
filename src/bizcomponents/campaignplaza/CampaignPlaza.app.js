...
import styles from './CampaignPlaza.app.less'
...
class CampaignPlazaBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  buildRouters = () =>{
  	...
  	{path:"/campaignPlaza/:id/list/campaignCreateForm", component: this.getCampaignCreateForm()},
  	{path:"/campaignPlaza/:id/list/campaignUpdateForm", component: this.getCampaignUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {CampaignPlazaEditDetail} = GlobalComponents
     //const {CampaignPlazaViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.campaignPlaza.id)}
