...
import styles from './CampaignRegisterHistory.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import CampaignRegisterHistoryBase from './CampaignRegisterHistory.base'


class CampaignRegisterHistoryTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = CampaignRegisterHistoryBase
    if(!referenceName){
...
export default CampaignRegisterHistoryTable
