...
class CampaignReviewBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/campaignReview/${this.props.campaignReview.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {CampaignReviewPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/campaignReview/:id/dashboard", component: CampaignReviewDashboard},
  	{path:"/campaignReview/:id/preference", component: CampaignReviewPreference},
