...
import styles from './CampaignReviewLike.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import CampaignReviewLikeBase from './CampaignReviewLike.base'


class CampaignReviewLikeTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = CampaignReviewLikeBase
    if(!referenceName){
...
export default CampaignReviewLikeTable
