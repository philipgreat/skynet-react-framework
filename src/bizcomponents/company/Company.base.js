...
const menuData = {menuName:"公司", menuFor: "company",
  		subItems: [
...
const displayColumns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>(<Link to={`/company/${text}/dashboard`}>{text}</Link>) },
...
const CompanyBase={menuData,displayColumns,fieldLabels}
