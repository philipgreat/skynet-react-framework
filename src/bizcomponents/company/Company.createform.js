...
import styles from './Company.createform.less'
...
class CompanyCreateForm extends Component {
  ...
  executeCandidatePlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = CompanyService.requestCandidatePlatform("dataPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addCompany`,
          payload: { id: owner.id, type: 'company', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'company',listName:'公司列表' },
      })
    }
