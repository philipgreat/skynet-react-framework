...
import styles from './Company.updateform.less'
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, companyId, ...imagesValues }

        // const newIndex= currentUpdateIndex + 1
        dispatch({
          type: `${owner.type}/updateCompany`,
          payload: {
            id: owner.id,
            type: 'company',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextCompanyUpdateRow`,
        payload: {
          id: owner.id,
          type: 'company',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新公司"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新公司"
