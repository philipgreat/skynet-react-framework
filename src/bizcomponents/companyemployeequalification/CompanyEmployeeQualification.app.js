...
class CompanyEmployeeQualificationBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/companyEmployeeQualification/${this.props.companyEmployeeQualification.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {CompanyEmployeeQualificationPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/companyEmployeeQualification/:id/dashboard", component: CompanyEmployeeQualificationDashboard},
  	{path:"/companyEmployeeQualification/:id/preference", component: CompanyEmployeeQualificationPreference},
