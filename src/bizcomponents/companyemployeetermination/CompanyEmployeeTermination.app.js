...
class CompanyEmployeeTerminationBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/companyEmployeeTermination/${this.props.companyEmployeeTermination.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {CompanyEmployeeTerminationPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/companyEmployeeTermination/:id/dashboard", component: CompanyEmployeeTerminationDashboard},
  	{path:"/companyEmployeeTermination/:id/preference", component: CompanyEmployeeTerminationPreference},
  	
  	
  	
  	{path:"/companyEmployeeTermination/:id/list/vehicleServiceCompanyEmployeeList", component: this.getVehicleServiceCompanyEmployeeSearch()},
  	{path:"/companyEmployeeTermination/:id/list/vehicleServiceCompanyEmployeeCreateForm", component: this.getVehicleServiceCompanyEmployeeCreateForm()},
  	{path:"/companyEmployeeTermination/:id/list/vehicleServiceCompanyEmployeeUpdateForm", component: this.getVehicleServiceCompanyEmployeeUpdateForm()},
