...
class ContractBizApp extends React.PureComponent {
  ...
  buildRouters = () =>{
  	...
  	{path:"/contract/:id/list/servicePriceList", component: this.getServicePriceSearch()},
  	{path:"/contract/:id/list/servicePriceCreateForm", component: this.getServicePriceCreateForm()},
  	{path:"/contract/:id/list/servicePriceUpdateForm", component: this.getServicePriceUpdateForm()},
