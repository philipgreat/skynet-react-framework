...
import styles from './CustomerAccountTransaction.dashboard.less'
...
class CustomerAccountTransactionDashboard extends Component {
...
}))(Form.create()(CustomerAccountTransactionDashboard))
