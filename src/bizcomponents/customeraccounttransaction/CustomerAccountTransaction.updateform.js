...
import styles from './CustomerAccountTransaction.updateform.less'
...
class CustomerAccountTransactionUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const customerAccountTransactionId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, customerAccountTransactionId, ...imagesValues }

        // const newIndex= currentUpdateIndex + 1
        dispatch({
          type: `${owner.type}/updateCustomerAccountTransaction`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextCustomerAccountTransactionUpdateRow`,
        payload: {
          id: owner.id,
          type: 'customerAccountTransaction',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新客户账户明细"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新客户账户明细"
...
}))(Form.create()(CustomerAccountTransactionUpdateForm))
