...
import styles from './DeliverMethod.app.less'
...
class DeliverMethodBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/deliverMethod/${this.props.deliverMethod.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/deliverMethod/${this.props.deliverMethod.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	const {DeliverMethodDashboard} = GlobalComponents
  	const {DeliverMethodPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/deliverMethod/:id/dashboard", component: DeliverMethodDashboard},
  	{path:"/deliverMethod/:id/preference", component: DeliverMethodPreference},
  	
  	
  	
  	{path:"/deliverMethod/:id/list/bookCopySharingApplicationList", component: this.getBookCopySharingApplicationSearch()},
  	{path:"/deliverMethod/:id/list/bookCopySharingApplicationCreateForm", component: this.getBookCopySharingApplicationCreateForm()},
  	{path:"/deliverMethod/:id/list/bookCopySharingApplicationUpdateForm", component: this.getBookCopySharingApplicationUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {DeliverMethodEditDetail} = GlobalComponents
     //const {DeliverMethodViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.deliverMethod.id)}
