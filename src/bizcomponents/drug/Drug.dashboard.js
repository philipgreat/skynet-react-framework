...
import styles from './Drug.dashboard.less'
...
const largeTextOf = (drug) =>{

	return(<div> 
   <Card title={`描述`} ><pre>{drug.description}</pre></Card>
</div>)
...
const summaryOf = (drug) =>{

	return (
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID">{drug.id}</Description> 
...
class DrugDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, drug } = this.props;
  ...
  render() {
    ...
    const { id,displayName, drugApplicationCount } = this.props.drug
    const cardsData = {cardsName:"药物",cardsFor: "drug",cardsSource: this.props.drug,
  		subItems: [
