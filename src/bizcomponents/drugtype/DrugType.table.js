...
import styles from './DrugType.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/drugType/${text}/dashboard`}>{text}</Link>) },
...
class DrugTypeTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
