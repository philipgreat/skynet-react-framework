...
import styles from './FormFieldMessage.preference.less'
...
const internalImageListOf = (formFieldMessage) =>{
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = FormFieldMessageService[candidateServiceName] 
...
const executeTrans = (formFieldMessage,targetComponent) =>{
...
const buildTransferModal = (formFieldMessage,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(formFieldMessage,targetComponent)}
...
const internalRenderExtraHeader = (formFieldMessage) =>{
	return null
}
const internalRenderExtraFooter = (formFieldMessage) =>{
	return null
}
...
class FormFieldMessagePreference extends Component {
...
}))(Form.create()(FormFieldMessagePreference))
