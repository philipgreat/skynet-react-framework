...
import styles from './FormMessage.preference.less'
...
const internalImageListOf = (formMessage) =>{
...
const internalSettingListOf = (formMessage) =>{
...
const handleTransferSearch =(targetComponent,filterKey,newRequest)=>{
  ...
  const pageNo = 1;
  const candidateReferenceService = FormMessageService[candidateServiceName] 
...
const executeTrans = (formMessage,targetComponent) =>{
...
const buildTransferModal = (formMessage,targetComponent) => {
...
<Modal title={transferModalTitle}
          ...
          onOk={()=>executeTrans(formMessage,targetComponent)}
...
const internalRenderExtraHeader = (formMessage) =>{
	return null
}
const internalRenderExtraFooter = (formMessage) =>{
	return null
}
...
class FormMessagePreference extends Component {
...
}))(Form.create()(FormMessagePreference))
