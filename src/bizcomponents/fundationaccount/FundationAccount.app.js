...
class FundationAccountBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/fundationAccount/${this.props.fundationAccount.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {FundationAccountPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/fundationAccount/:id/dashboard", component: FundationAccountDashboard},
  	{path:"/fundationAccount/:id/preference", component: FundationAccountPreference},
