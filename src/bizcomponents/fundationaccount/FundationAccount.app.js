...
class FundationAccountBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/serviceFileMovementC2m/${this.props.serviceFileMovementC2m.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
<<<<<<< HEAD:src/bizcomponents/servicefilemovementc2m/ServiceFileMovementC2m.app.js
  	const {ServiceFileMovementC2mDashboard} = GlobalComponents
  	const {ServiceFileMovementC2mPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/serviceFileMovementC2m/:id/dashboard", component: ServiceFileMovementC2mDashboard},
  	{path:"/serviceFileMovementC2m/:id/preference", component: ServiceFileMovementC2mPreference},
  	
=======
  	const {FundationAccountDashboard} = GlobalComponents
  	
  	const routers=[
  	{path:"/fundationAccount/:id/dashboard", component: FundationAccountDashboard},
>>>>>>> 69fce8703114b35fde9082e9f806d4b3dd160efb:src/bizcomponents/fundationaccount/FundationAccount.app.js
  	
  	
  	{path:"/fundationAccount/:id/list/fundationAccountDetailsList", component: this.getFundationAccountDetailsSearch()},
  	{path:"/fundationAccount/:id/list/fundationAccountDetailsCreateForm", component: this.getFundationAccountDetailsCreateForm()},
  	{path:"/fundationAccount/:id/list/fundationAccountDetailsUpdateForm", component: this.getFundationAccountDetailsUpdateForm()},
