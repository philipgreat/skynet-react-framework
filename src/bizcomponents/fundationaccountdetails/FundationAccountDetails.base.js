...
const displayColumns = [
  ...
  { title: '摘要', debugtype: 'string', dataIndex: 'summary', width: '12',render: (text, record)=>renderTextCell(text,record) },
  ...
  { title: '平台基金账户', dataIndex: 'fundationAccount', render: (text, record) => renderReferenceCell(text, record)},
