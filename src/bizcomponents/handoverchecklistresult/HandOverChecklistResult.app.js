...
class HandOverChecklistResultBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/handOverChecklistResult/${this.props.handOverChecklistResult.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {HandOverChecklistResultPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/handOverChecklistResult/:id/dashboard", component: HandOverChecklistResultDashboard},
  	{path:"/handOverChecklistResult/:id/preference", component: HandOverChecklistResultPreference},
