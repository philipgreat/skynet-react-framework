...
export default {
  ...
  subscriptions: {
    ...
    setup({ dispatch, history }) { 
      history.listen((location) => {
      	const modelName = 'handOverChecklistResult'
  ...
  effects: {
    ...
    *doJob({ payload }, { call, put }) { 
      ...
      if(!HandOverChecklistResultService[serviceNameToCall]){
      	handleClientError("找不到后台服务: "+serviceNameToCall)
      	return;
      }
      
      const data = yield call(HandOverChecklistResultService[serviceNameToCall], id, parameters)
