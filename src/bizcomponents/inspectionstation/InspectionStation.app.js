...
class InspectionStationBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/inspectionStation/${this.props.inspectionStation.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {InspectionStationPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/inspectionStation/:id/dashboard", component: InspectionStationDashboard},
  	{path:"/inspectionStation/:id/preference", component: InspectionStationPreference},
