...
import styles from './InspectionStationAccount.preference.less'
...
class InspectionStationAccountPreference extends Component {
...
}))(Form.create()(InspectionStationAccountPreference))
