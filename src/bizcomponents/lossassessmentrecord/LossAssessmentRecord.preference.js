...
import styles from './LossAssessmentRecord.preference.less'
...
class LossAssessmentRecordPreference extends Component {
...
}))(Form.create()(LossAssessmentRecordPreference))
