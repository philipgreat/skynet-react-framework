...
import styles from './LossDiscount.app.less'
...
class LossDiscountBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/lossDiscount/${this.props.lossDiscount.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/lossDiscount/${this.props.lossDiscount.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	const {LossDiscountDashboard} = GlobalComponents
  	const {LossDiscountPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/lossDiscount/:id/dashboard", component: LossDiscountDashboard},
  	{path:"/lossDiscount/:id/preference", component: LossDiscountPreference},
  	
  	
  	
  	{path:"/lossDiscount/:id/list/lossAssessmentRecordList", component: this.getLossAssessmentRecordSearch()},
  	{path:"/lossDiscount/:id/list/lossAssessmentRecordCreateForm", component: this.getLossAssessmentRecordCreateForm()},
  	{path:"/lossDiscount/:id/list/lossAssessmentRecordUpdateForm", component: this.getLossAssessmentRecordUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {LossDiscountEditDetail} = GlobalComponents
     //const {LossDiscountViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.lossDiscount.id)}
...
export default connect(state => ({
  ...
  lossDiscount: state._lossDiscount,
  ...state,
}))(LossDiscountBizApp)
