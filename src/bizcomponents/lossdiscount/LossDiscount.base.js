...
const menuData = {menuName:"定损折扣", menuFor: "lossDiscount",
  		subItems: [
...
const displayColumns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderIdentifier(text,record,'lossDiscount') },
  ...
  { title: '折扣', debugtype: 'double', dataIndex: 'discountRatio', width: '7',render: (text, record)=>renderTextCell(text,record) },
