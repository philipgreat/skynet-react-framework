...
import styles from './LossDiscount.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import LossDiscountBase from './LossDiscount.base'
...
class LossDiscountCreateForm extends Component {
  state = {
  ...
  executeCandidateBookSharingPlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = LossDiscountService.requestCandidateBookSharingPlatform("bookSharingPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addLossDiscount`,
          payload: { id: owner.id, type: 'lossDiscount', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(LossDiscountCreateForm))
