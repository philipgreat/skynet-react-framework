...
import styles from './MemberRightsDisplay.app.less'
...
class MemberRightsDisplayBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/memberRightsDisplay/${this.props.memberRightsDisplay.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/memberRightsDisplay/${this.props.memberRightsDisplay.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getMemberRightsDisplayItemSearch = () => {
  ...
  getMemberRightsDisplayItemUpdateForm = () => {
  ...
  buildRouters = () =>{
  	const {MemberRightsDisplayDashboard} = GlobalComponents
  	const {MemberRightsDisplayPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/memberRightsDisplay/:id/dashboard", component: MemberRightsDisplayDashboard},
  	{path:"/memberRightsDisplay/:id/preference", component: MemberRightsDisplayPreference},
  	
  	
  	
  	{path:"/memberRightsDisplay/:id/list/memberRightsDisplayItemList", component: this.getMemberRightsDisplayItemSearch()},
  	{path:"/memberRightsDisplay/:id/list/memberRightsDisplayItemCreateForm", component: this.getMemberRightsDisplayItemCreateForm()},
  	{path:"/memberRightsDisplay/:id/list/memberRightsDisplayItemUpdateForm", component: this.getMemberRightsDisplayItemUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {MemberRightsDisplayEditDetail} = GlobalComponents
     //const {MemberRightsDisplayViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.memberRightsDisplay.id)}
