...
import styles from './MemberRightsDisplay.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import MemberRightsDisplayBase from './MemberRightsDisplay.base'


class MemberRightsDisplayTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = MemberRightsDisplayBase
    if(!referenceName){
...
export default MemberRightsDisplayTable
