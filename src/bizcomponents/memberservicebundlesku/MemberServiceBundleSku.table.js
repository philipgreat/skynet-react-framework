...
import styles from './MemberServiceBundleSku.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import MemberServiceBundleSkuBase from './MemberServiceBundleSku.base'


class MemberServiceBundleSkuTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = MemberServiceBundleSkuBase
    if(!referenceName){
...
export default MemberServiceBundleSkuTable
