...
import styles from './MemberServiceBundleSku.updateform.less'
...
class MemberServiceBundleSkuUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const memberServiceBundleSkuId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, memberServiceBundleSkuId, ...imagesValues }

        // const newIndex= currentUpdateIndex + 1
        dispatch({
          type: `${owner.type}/updateMemberServiceBundleSku`,
          payload: {
            id: owner.id,
            type: 'memberServiceBundleSku',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextMemberServiceBundleSkuUpdateRow`,
        payload: {
          id: owner.id,
          type: 'memberServiceBundleSku',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新会员服务包"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新会员服务包"
...
}))(Form.create()(MemberServiceBundleSkuUpdateForm))
