...
import styles from './MemberServiceIncomeMetric.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import MemberServiceIncomeMetricBase from './MemberServiceIncomeMetric.base'


class MemberServiceIncomeMetricTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = MemberServiceIncomeMetricBase
    if(!referenceName){
...
export default MemberServiceIncomeMetricTable
