...
import styles from './MemberServiceRevenue.app.less'
...
class MemberServiceRevenueBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {MemberServiceRevenueEditDetail} = GlobalComponents
     //const {MemberServiceRevenueViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.memberServiceRevenue.id)}
