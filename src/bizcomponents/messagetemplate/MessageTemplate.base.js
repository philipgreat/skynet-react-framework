...
const displayColumns = [
  ...
  { title: '模板', debugtype: 'string_longtext', dataIndex: 'template', width: '10',render: (text, record)=>renderTextCell(text,record) },
  { title: '更新人', dataIndex: 'updatedBy', render: (text, record) => renderReferenceCell(text, record)},
