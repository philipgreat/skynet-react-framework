...
import styles from './NewsSubscription.createform.less'
...
class NewsSubscriptionCreateForm extends Component {
  state = {
  ...
  executeCandidatePlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = NewsSubscriptionService.requestCandidatePlatform("dataPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addNewsSubscription`,
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addNewsSubscription`,
          payload: { id: owner.id, type: 'newsSubscription', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'newsSubscription',listName:'新闻订阅列表' },
      })
    }
...
}))(Form.create()(NewsSubscriptionCreateForm))
