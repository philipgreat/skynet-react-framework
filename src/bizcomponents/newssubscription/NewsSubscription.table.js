...
const columns = [
  ...
  { title: '电子邮件地址', debugtype: 'string_email', dataIndex: 'emailAddress',},
  { title: '手机号码', debugtype: 'string_china_mobile_phone', dataIndex: 'mobile',},
  { title: '备注', debugtype: 'string', dataIndex: 'remark',},
...
class NewsSubscriptionTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default NewsSubscriptionTable
