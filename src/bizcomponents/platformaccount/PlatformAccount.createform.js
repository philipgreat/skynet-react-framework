...
import PlatformAccountBase from './PlatformAccount.base'
...
/*
const testValues = {
<<<<<<< HEAD:src/bizcomponents/contract/Contract.createform.js
...
>>>>>>> 69fce8703114b35fde9082e9f806d4b3dd160efb:src/bizcomponents/platformaccount/PlatformAccount.createform.js
}
*/
...
class PlatformAccountCreateForm extends Component {
  ...
  executeCandidateAccountDataSearch = (filterKey) =>{
    ...
    const id = "";//not used for now
    const pageNo = 1;
    const future = PlatformAccountService.requestCandidateAccountData("accountData", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const {fieldLabels} = PlatformAccountBase
