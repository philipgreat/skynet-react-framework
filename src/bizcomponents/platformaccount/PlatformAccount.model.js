  ...
  subscriptions: {
    ...
    setup({ dispatch, history }) { 
      history.listen((location) => {
      	const modelName = 'platformAccount'
...
<<<<<<< HEAD:src/bizcomponents/companyemployeequalification/CompanyEmployeeQualification.model.js
      const cachedData = yield select(state => state._companyEmployeeQualification)
=======
      const cachedData = yield select(state => state._platformAccount)
>>>>>>> 69fce8703114b35fde9082e9f806d4b3dd160efb:src/bizcomponents/platformaccount/PlatformAccount.model.js
...
>>>>>>> 69fce8703114b35fde9082e9f806d4b3dd160efb:src/bizcomponents/platformaccount/PlatformAccount.model.js
    ...
    *doJob({ payload }, { call, put }) { 
      ...
      if(!PlatformAccountService[serviceNameToCall]){
      	handleClientError("找不到后台服务: "+serviceNameToCall)
      	return;
      }
      
      const data = yield call(PlatformAccountService[serviceNameToCall], id, parameters)
