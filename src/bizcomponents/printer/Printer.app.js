...
class PrinterBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/fileInspectionPlateNumberPattern/${this.props.fileInspectionPlateNumberPattern.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
<<<<<<< HEAD:src/bizcomponents/fileinspectionplatenumberpattern/FileInspectionPlateNumberPattern.app.js
  	const {FileInspectionPlateNumberPatternDashboard} = GlobalComponents
  	const {FileInspectionPlateNumberPatternPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/fileInspectionPlateNumberPattern/:id/dashboard", component: FileInspectionPlateNumberPatternDashboard},
  	{path:"/fileInspectionPlateNumberPattern/:id/preference", component: FileInspectionPlateNumberPatternPreference},
...
>>>>>>> 69fce8703114b35fde9082e9f806d4b3dd160efb:src/bizcomponents/printer/Printer.app.js
