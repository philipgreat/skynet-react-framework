...
const displayColumns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderIdentifier(text,record,'printer') },
  { title: '名称', debugtype: 'string', dataIndex: 'name', width: '16',render: (text, record)=>renderTextCell(text,record) },
