...
import styles from './PrivateMessage.updateform.less'
...
class PrivateMessageUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const privateMessageId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, privateMessageId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updatePrivateMessage`,
          payload: {
            id: owner.id,
            type: 'privateMessage',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextPrivateMessageUpdateRow`,
        payload: {
          id: owner.id,
          type: 'privateMessage',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新私信消息"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新私信消息"
...
}))(Form.create()(PrivateMessageUpdateForm))
