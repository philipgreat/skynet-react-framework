...
import styles from './ProfitDistributeState.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import ProfitDistributeStateBase from './ProfitDistributeState.base'
...
class ProfitDistributeStateCreateForm extends Component {
  state = {
  ...
  executeCandidatePlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = ProfitDistributeStateService.requestCandidatePlatform("bookSharingPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addProfitDistributeState`,
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addProfitDistributeState`,
          payload: { id: owner.id, type: 'profitDistributeState', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'profitDistributeState',listName:'利润分配状态列表' },
      })
    }
...
}))(Form.create()(ProfitDistributeStateCreateForm))
