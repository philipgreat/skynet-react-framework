...
import styles from './ProfitDistributeState.preference.less'
...
class ProfitDistributeStatePreference extends Component {
...
}))(Form.create()(ProfitDistributeStatePreference))
