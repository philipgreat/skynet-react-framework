...
import styles from './ProfitDistributeState.updateform.less'
...
class ProfitDistributeStateUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextProfitDistributeStateUpdateRow`,
        payload: {
          id: owner.id,
          type: 'profitDistributeState',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新利润分配状态"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新利润分配状态"
...
}))(Form.create()(ProfitDistributeStateUpdateForm))
