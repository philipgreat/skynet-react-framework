...
import styles from './ProfitType.preference.less'
...
class ProfitTypePreference extends Component {
  ...
  render() {
    ...
    const { id,displayName, undistributedProfitCount } = this.props.profitType
...
}))(Form.create()(ProfitTypePreference))
