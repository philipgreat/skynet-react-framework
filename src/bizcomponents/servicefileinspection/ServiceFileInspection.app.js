...
class ServiceFileInspectionBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/serviceFileInspection/${this.props.serviceFileInspection.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {ServiceFileInspectionPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/serviceFileInspection/:id/dashboard", component: ServiceFileInspectionDashboard},
  	{path:"/serviceFileInspection/:id/preference", component: ServiceFileInspectionPreference},
