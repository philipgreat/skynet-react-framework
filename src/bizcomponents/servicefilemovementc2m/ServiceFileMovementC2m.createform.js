...
const testValues = {
  ...
  startTime: '2016-05-27 09:53:26',
  longitude: '103.48529894901715',
  latitude: '30.278902669774435',
  transferVerifyCode: 'O12345',
  movementPurpose: 'FILE_C2M_RECEIVE_IN_STORE',
  contactName: '张秋文',
  contactMobileNumber: '13812345678',
  notifyDatetime: '2016-01-29 01:09:11',
  notifyAddress: '',
  handoverResult: '',
...
class ServiceFileMovementC2mCreateForm extends Component {
  ...
  render() {
    ...
    const {fieldLabels} = ServiceFileMovementC2mBase
