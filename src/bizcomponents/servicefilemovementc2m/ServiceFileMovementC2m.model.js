...
export default {
  ...
  subscriptions: {
    ...
    setup({ dispatch, history }) { 
      history.listen((location) => {
      	const modelName = 'serviceFileMovementC2m'
  ...
  effects: {
    ...
    *doJob({ payload }, { call, put }) { 
      ...
      if(!ServiceFileMovementC2mService[serviceNameToCall]){
      	handleClientError("找不到后台服务: "+serviceNameToCall)
      	return;
      }
      
      const data = yield call(ServiceFileMovementC2mService[serviceNameToCall], id, parameters)
