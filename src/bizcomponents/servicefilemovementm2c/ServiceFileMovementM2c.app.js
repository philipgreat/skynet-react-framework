...
class ServiceFileMovementM2cBizApp extends React.PureComponent {
  ...
  buildRouters = () =>{
  	...
  	{path:"/serviceFileMovementM2c/:id/list/handOverChecklistResultList", component: this.getHandOverChecklistResultSearch()},
  	{path:"/serviceFileMovementM2c/:id/list/handOverChecklistResultCreateForm", component: this.getHandOverChecklistResultCreateForm()},
  	{path:"/serviceFileMovementM2c/:id/list/handOverChecklistResultUpdateForm", component: this.getHandOverChecklistResultUpdateForm()},
