...
const testValues = {
  ...
  startTime: '2016-04-29 12:21:33',
  longitude: '103.26995640315067',
  latitude: '31.597629194703217',
  transferVerifyCode: 'O12345',
  movementPurpose: 'FILE_M2C_IN_STORE',
  contactName: '张秋文',
  contactMobileNumber: '13812345678',
  notifyDatetime: '2018-06-17 10:00:08',
  notifyAddress: '',
  handoverResult: '',
...
class ServiceFileMovementM2cCreateForm extends Component {
  ...
  render() {
    ...
    const {fieldLabels} = ServiceFileMovementM2cBase
