...
class ServiceFileMovementM2mBizApp extends React.PureComponent {
  ...
  buildRouters = () =>{
  	...
  	{path:"/serviceFileMovementM2m/:id/list/handOverChecklistResultCreateForm", component: this.getHandOverChecklistResultCreateForm()},
  	{path:"/serviceFileMovementM2m/:id/list/handOverChecklistResultUpdateForm", component: this.getHandOverChecklistResultUpdateForm()},
