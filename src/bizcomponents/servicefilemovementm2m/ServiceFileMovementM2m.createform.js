...
const testValues = {
  ...
  startTime: '2018-04-20 13:04:06',
  longitude: '103.14297324247926',
  latitude: '29.836461553224765',
  transferVerifyCode: 'O12345',
  movementPurpose: 'FILE_M2M_PICK_IN_STORE',
  notifyDatetime: '2018-03-22 13:30:33',
  notifyAddress: '',
  handoverResult: '',
...
class ServiceFileMovementM2mCreateForm extends Component {
  ...
  render() {
    ...
    const {fieldLabels} = ServiceFileMovementM2mBase
