...
class ServiceVehicleInspectionBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/serviceVehicleInspection/${this.props.serviceVehicleInspection.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {ServiceVehicleInspectionPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/serviceVehicleInspection/:id/dashboard", component: ServiceVehicleInspectionDashboard},
  	{path:"/serviceVehicleInspection/:id/preference", component: ServiceVehicleInspectionPreference},
  	
  	
  	
  	{path:"/serviceVehicleInspection/:id/list/serviceVehicleRepairingList", component: this.getServiceVehicleRepairingSearch()},
  	{path:"/serviceVehicleInspection/:id/list/serviceVehicleRepairingCreateForm", component: this.getServiceVehicleRepairingCreateForm()},
  	{path:"/serviceVehicleInspection/:id/list/serviceVehicleRepairingUpdateForm", component: this.getServiceVehicleRepairingUpdateForm()},
