...
import ServiceVehicleMovementC2mBase from './ServiceVehicleMovementC2m.base'
...
const testValues = {
  ...
  startTime: '2017-07-29 08:28:16',
  longitude: '105.46909073900433',
  latitude: '29.745675953025085',
  transferVerifyCode: 'O12345',
  movementPurpose: 'VEHICLE_C2M_RECEIVE_IN_STORE',
  contactName: '张秋文',
  contactMobileNumber: '13812345678',
  notifyDatetime: '2015-09-23 16:22:59',
  notifyAddress: '',
  handoverResult: '',
...
class ServiceVehicleMovementC2mCreateForm extends Component {
  ...
  render() {
    ...
    const {fieldLabels} = ServiceVehicleMovementC2mBase
