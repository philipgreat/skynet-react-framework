...
class ServiceVehicleRepairingBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/serviceVehicleRepairing/${this.props.serviceVehicleRepairing.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {ServiceVehicleRepairingPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/serviceVehicleRepairing/:id/dashboard", component: ServiceVehicleRepairingDashboard},
  	{path:"/serviceVehicleRepairing/:id/preference", component: ServiceVehicleRepairingPreference},
  	
  	
  	
  	{path:"/serviceVehicleRepairing/:id/list/repairingAllowanceItemList", component: this.getRepairingAllowanceItemSearch()},
  	{path:"/serviceVehicleRepairing/:id/list/repairingAllowanceItemCreateForm", component: this.getRepairingAllowanceItemCreateForm()},
  	{path:"/serviceVehicleRepairing/:id/list/repairingAllowanceItemUpdateForm", component: this.getRepairingAllowanceItemUpdateForm()},
   	
  	{path:"/serviceVehicleRepairing/:id/list/vehicleRepairingPaymentList", component: this.getVehicleRepairingPaymentSearch()},
  	{path:"/serviceVehicleRepairing/:id/list/vehicleRepairingPaymentCreateForm", component: this.getVehicleRepairingPaymentCreateForm()},
  	{path:"/serviceVehicleRepairing/:id/list/vehicleRepairingPaymentUpdateForm", component: this.getVehicleRepairingPaymentUpdateForm()},
