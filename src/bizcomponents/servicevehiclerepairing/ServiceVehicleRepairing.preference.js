...
import styles from './ServiceVehicleRepairing.preference.less'
...
class ServiceVehicleRepairingPreference extends Component {
...
}))(Form.create()(ServiceVehicleRepairingPreference))
