...
import styles from './SlideType.app.less'
...
class SlideTypeBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/slideType/${this.props.slideType.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/slideType/${this.props.slideType.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	const {SlideTypeDashboard} = GlobalComponents
  	const {SlideTypePreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/slideType/:id/dashboard", component: SlideTypeDashboard},
  	{path:"/slideType/:id/preference", component: SlideTypePreference},
  	
  	
  	
  	{path:"/slideType/:id/list/storeSlideList", component: this.getStoreSlideSearch()},
  	{path:"/slideType/:id/list/storeSlideCreateForm", component: this.getStoreSlideCreateForm()},
  	{path:"/slideType/:id/list/storeSlideUpdateForm", component: this.getStoreSlideUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {SlideTypeEditDetail} = GlobalComponents
     //const {SlideTypeViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.slideType.id)}
