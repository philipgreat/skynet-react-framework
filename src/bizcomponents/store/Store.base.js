...
const displayColumns = [
  ...
  { title: '网点副标题', debugtype: 'string', dataIndex: 'storeSubname', width: '9' },
  { title: '网点地址', debugtype: 'string', dataIndex: 'storeAddress', width: '8' },
  { title: '网点营业时间', debugtype: 'string', dataIndex: 'storeOpenTime', width: '19' },
  { title: '网点营业时间补充说明', debugtype: 'string', dataIndex: 'storeOpenTimeSecond', width: '19' },
  ...
  { title: '网点类型', dataIndex: 'storeType', render: (text, record) => (record.storeType ? record.storeType.displayName : '暂无') },
