...
{name: 'bookCopyTransferListAsOriginalStore', displayName:'图书副本迁移记录',type:'bookCopyTransfer',count:bookCopyTransferAsOriginalStoreCount},
{name: 'bookCopyTransferListAsNewStore', displayName:'图书副本迁移记录',type:'bookCopyTransfer',count:bookCopyTransferAsNewStoreCount},
...
{name: 'borrowingHistoryListAsLendingStore', displayName:'图书借还历史',type:'borrowingHistory',count:borrowingHistoryAsLendingStoreCount},
{name: 'borrowingHistoryListAsReturnStore', displayName:'图书借还历史',type:'borrowingHistory',count:borrowingHistoryAsReturnStoreCount},
{name: 'borrowingExpiredSkuListAsLendingStore', displayName:'借书超期费',type:'borrowingExpiredSku',count:borrowingExpiredSkuAsLendingStoreCount},
{name: 'borrowingExpiredSkuListAsReturnStore', displayName:'借书超期费',type:'borrowingExpiredSku',count:borrowingExpiredSkuAsReturnStoreCount},
