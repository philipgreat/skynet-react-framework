...
class StoreSlideSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      storeSlideList: 1,
      'storeSlideList.searchField': fieldName,
      'storeSlideList.searchVerb': 'startsWith',
      'storeSlideList.searchValue': fieldValue,
    }
  }
  handleSearch = (e) => {
    e.preventDefault()
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, parameters: params, storeSlideSearchFormParameters: fieldsValue },
      })
    })
  }
...
export default Form.create()(StoreSlideSearchForm)
