...
export default {
  ...
  effects: {
    ...
    *gotoCreateForm({ payload }, { put }) {
      ...
      yield put(routerRedux.push(`/storeType/${id}/list/${role}CreateForm`))
    },
    *gotoUpdateForm({ payload }, { put }) {
      const { id, role, selectedRows, currentUpdateIndex } = payload
      const state = { id, role, selectedRows, currentUpdateIndex }
      const location = { pathname: `/storeType/${id}/list/${role}UpdateForm`, state }
    ...
    *addStore({ payload }, { call, put }) {
      ...
      const location = { pathname: `/storeType/${id}/list/\StoreList/服务网点列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateStore({ payload }, { call, put }) {
      ...
      const location = { pathname: `/storeType/${id}/list/\StoreList/服务网点列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
