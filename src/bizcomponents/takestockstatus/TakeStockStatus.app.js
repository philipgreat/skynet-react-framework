...
import styles from './TakeStockStatus.app.less'
...
class TakeStockStatusBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/takeStockStatus/${this.props.takeStockStatus.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/takeStockStatus/${this.props.takeStockStatus.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	const {TakeStockStatusDashboard} = GlobalComponents
  	const {TakeStockStatusPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/takeStockStatus/:id/dashboard", component: TakeStockStatusDashboard},
  	{path:"/takeStockStatus/:id/preference", component: TakeStockStatusPreference},
  	
  	
  	
  	{path:"/takeStockStatus/:id/list/bookTakeStockPlanList", component: this.getBookTakeStockPlanSearch()},
  	{path:"/takeStockStatus/:id/list/bookTakeStockPlanCreateForm", component: this.getBookTakeStockPlanCreateForm()},
  	{path:"/takeStockStatus/:id/list/bookTakeStockPlanUpdateForm", component: this.getBookTakeStockPlanUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {TakeStockStatusEditDetail} = GlobalComponents
     //const {TakeStockStatusViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.takeStockStatus.id)}
