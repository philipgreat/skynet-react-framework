...
import styles from './TakeStockStatus.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import TakeStockStatusBase from './TakeStockStatus.base'


class TakeStockStatusTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = TakeStockStatusBase
    if(!referenceName){
...
export default TakeStockStatusTable
