...
import styles from './TakeStoreResults.table.less'
import ImagePreview from '../../components/ImagePreview'
import GlobalComponents from '../../custcomponents';
import TakeStoreResultsBase from './TakeStoreResults.base'


class TakeStoreResultsTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
 ...
 calcDisplayColumns=()=>{
    ...
    const {displayColumns} = TakeStoreResultsBase
    if(!referenceName){
...
export default TakeStoreResultsTable
