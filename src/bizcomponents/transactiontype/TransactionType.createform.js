...
import styles from './TransactionType.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import TransactionTypeBase from './TransactionType.base'
...
class TransactionTypeCreateForm extends Component {
  ...
  executeCandidateAccountDataSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = TransactionTypeService.requestCandidateAccountData("accountData", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const {fieldLabels} = TransactionTypeBase
    const submitCreateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addTransactionType`,
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addTransactionType`,
          payload: { id: owner.id, type: 'transactionType', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'transactionType',listName:'交易类型列表' },
      })
    }
...
}))(Form.create()(TransactionTypeCreateForm))
