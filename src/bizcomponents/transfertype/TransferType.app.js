...
import styles from './TransferType.app.less'
...
class TransferTypeBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = () => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/transferType/${this.props.transferType.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/transferType/${this.props.transferType.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	const {TransferTypeDashboard} = GlobalComponents
  	const {TransferTypePreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/transferType/:id/dashboard", component: TransferTypeDashboard},
  	{path:"/transferType/:id/preference", component: TransferTypePreference},
  	
  	
  	
  	{path:"/transferType/:id/list/bookCopyTransferList", component: this.getBookCopyTransferSearch()},
  	{path:"/transferType/:id/list/bookCopyTransferCreateForm", component: this.getBookCopyTransferCreateForm()},
  	{path:"/transferType/:id/list/bookCopyTransferUpdateForm", component: this.getBookCopyTransferUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {TransferTypeEditDetail} = GlobalComponents
     //const {TransferTypeViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
         ...
         >
             ...
             {this.getNavMenuItems(this.props.transferType.id)}
