...
import styles from './UndistributedProfit.updateform.less'
...
class UndistributedProfitUpdateForm extends Component {
  state = {
  ...
  getSelectedRow() {
    ...
    const convertiedValues = selectedRows.map((item) => {
      return {
        ...item,
        chargeStartDate: moment(item.chargeStartDate),
        chargeEndDate: moment(item.chargeEndDate),
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const undistributedProfitId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, undistributedProfitId, ...imagesValues }

        // const newIndex= currentUpdateIndex + 1
        dispatch({
          type: `${owner.type}/updateUndistributedProfit`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextUndistributedProfitUpdateRow`,
        payload: {
          id: owner.id,
          type: 'undistributedProfit',
          selectedRows,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.chargeStartDate} {...formItemLayout}>
                  {getFieldDecorator('chargeStartDate', {
                    initialValue: selectedRow.chargeStartDate,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.chargeEndDate} {...formItemLayout}>
                  {getFieldDecorator('chargeEndDate', {
                    initialValue: selectedRow.chargeEndDate,
...
}))(Form.create()(UndistributedProfitUpdateForm))
