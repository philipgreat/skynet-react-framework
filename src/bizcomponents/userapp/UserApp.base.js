...
const menuData = {menuName:"用户应用程序", menuFor: "userApp",
  		subItems: [
  {name: 'objectAccessList', displayName:'对象访问', icon:'accessible-icon'},
...
const displayColumns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderIdentifier(text,record,'userApp') },
