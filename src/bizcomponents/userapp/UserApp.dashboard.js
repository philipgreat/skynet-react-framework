...
class UserAppDashboard extends Component {
  ...
  render() {
    ...
    const { id,displayName, objectAccessAccessiable, objectAccessCount } = this.props.userApp
    const cardsData = {cardsName:"用户应用程序",cardsFor: "userApp",cardsSource: this.props.userApp,
  		subItems: [
{name: 'objectAccessList', displayName:'对象访问',type:'objectAccess',count:objectAccessCount,addFunction: true, role: 'objectAccess', accessiable: objectAccessAccessiable},
