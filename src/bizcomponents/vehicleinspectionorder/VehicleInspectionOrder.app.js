...
class VehicleInspectionOrderBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/vehicleInspectionOrder/${this.props.vehicleInspectionOrder.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {VehicleInspectionOrderPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/vehicleInspectionOrder/:id/dashboard", component: VehicleInspectionOrderDashboard},
  	{path:"/vehicleInspectionOrder/:id/preference", component: VehicleInspectionOrderPreference},
