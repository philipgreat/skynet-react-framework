...
const testValues = {
  ...
  createTime: '2017-07-25 11:33:16',
  contactName: '张俊宝',
  contactMobileNumber: '13812345678',
  productType: '上线检测',
  contactAddressDetail: '四川省成都市学院路东段919号',
  planInspectionDate: '2016-09-11',
  vehicleType: '面包车',
  vehicleUseCharacter: '营运',
  vehicleSeatsQuantity: '5',
  vehicleRegistrationDate: '2018-05-14',
  inspectionValidationDate: '2017-07-16',
  insuranceValidationDate: '2018-05-25',
  engineNumber: '',
  vehicleIdentificationNumber: '',
  vehiclePermitIssueDate: '2018-04-16',
  vehiclePermitHolderName: '李立国',
  longitude: '104.08385508015152',
  latitude: '31.008591884207515',
