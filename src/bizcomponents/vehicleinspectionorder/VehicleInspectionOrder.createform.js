...
const testValues = {
  ...
  createTime: '2016-08-07 18:48:34',
  contactName: '张俊宝',
  contactMobileNumber: '13812345678',
  productType: '上线检测',
  contactAddressDetail: '四川省成都市学院路东段919号',
  planInspectionDate: '2016-01-23',
  vehicleType: '面包车',
  vehicleUseCharacter: '营运',
  vehicleSeatsQuantity: '5',
  vehicleRegistrationDate: '2017-10-26',
  inspectionValidationDate: '2018-04-18',
  insuranceValidationDate: '2016-04-03',
  engineNumber: '',
  vehicleIdentificationNumber: '',
  vehiclePermitIssueDate: '2017-09-13',
  vehiclePermitHolderName: '李立国',
  longitude: '104.47804894055511',
  latitude: '31.29986299412755',
