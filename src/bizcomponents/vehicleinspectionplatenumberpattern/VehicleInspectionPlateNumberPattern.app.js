...
class VehicleInspectionPlateNumberPatternBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/vehicleInspectionPlateNumberPattern/${this.props.vehicleInspectionPlateNumberPattern.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {VehicleInspectionPlateNumberPatternPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/vehicleInspectionPlateNumberPattern/:id/dashboard", component: VehicleInspectionPlateNumberPatternDashboard},
  	{path:"/vehicleInspectionPlateNumberPattern/:id/preference", component: VehicleInspectionPlateNumberPatternPreference},
