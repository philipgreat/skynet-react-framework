...
export default {
  ...
  subscriptions: {
    ...
    setup({ dispatch, history }) { 
      history.listen((location) => {
      	const modelName = 'vehicleRepairingAllowance'
  ...
  effects: {
    ...
    *doJob({ payload }, { call, put }) { 
      ...
      if(!VehicleRepairingAllowanceService[serviceNameToCall]){
      	handleClientError("找不到后台服务: "+serviceNameToCall)
      	return;
      }
      
      const data = yield call(VehicleRepairingAllowanceService[serviceNameToCall], id, parameters)
