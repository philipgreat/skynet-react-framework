...
class VehicleServiceCompanyEmployeeBizApp extends React.PureComponent {
  ...
  getNavMenuItems = () => {
    ...
    return (
       ...
       <Menu.Item key="preference">
               <Link to={`/vehicleServiceCompanyEmployee/${this.props.vehicleServiceCompanyEmployee.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  buildRouters = () =>{
  	...
  	const {VehicleServiceCompanyEmployeePreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/vehicleServiceCompanyEmployee/:id/dashboard", component: VehicleServiceCompanyEmployeeDashboard},
  	{path:"/vehicleServiceCompanyEmployee/:id/preference", component: VehicleServiceCompanyEmployeePreference},
