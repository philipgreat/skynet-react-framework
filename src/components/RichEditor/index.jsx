...
const client = (token) => {
  const {region='', accessKeyId='', accessKeySecret='', bucket='', SecurityToken='', endpoint=''} = token
  return oss({
    region,
    accessKeyId,
    accessKeySecret,
      ...
      <Fragment>
        <Editor
          ...
          init={{
            ...
            paste_word_valid_elements: "table[width],tr,td[colspan|rowspan|width],th[colspan|rowspan|width],thead,tfoot,tbody",
